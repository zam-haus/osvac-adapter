...
outer_diameter = inner_diameter + inner_diameter_narrow;
...
difference() {
    union() {
        cylinder(depth+top_wall_thickness, d1 = inner_diameter, d2 = inner_diameter + inner_diameter_narrow);
    }
...
translate([0,0,depth+top_wall_thickness-e]) difference() {
    cylinder(chamfer, d1 = outer_diameter, d2 = osvac_outer_diam);
